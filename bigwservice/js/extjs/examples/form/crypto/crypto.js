...
Ext.onReady(function() {
	...
	var generatePassword = function(salt, originPass){
    	var passnsalt = originPass+salt;
		var encryptedPass = Sha1.hash(passnsalt);
                ...
                handler: function() {
                    ...
                    */
                    ...
                    if (form.isValid()) {
                        ...
                        alert(form.password1.getValue());
                        //alert(generatePassword('hey', 'how are you?'));
                    }
                }
            }]
        }]
